...
with open(os.path.join('/home/user/Segmentation_final3/irseg', f'all1.txt'), 'r') as f:
...
for i in range(len(image_labels)):
    ...
    imgrgb= cv2.imread('/home/user/Segmentation_final3/irseg/seperated_images/' + label_path1 + '_rgb.png' , 0)
    imgdepth = cv2.imread('/home/user/Segmentation_final3/irseg/seperated_images/' + label_path1 + '_th.png', 0)
    ...
    # cv2.imwrite('/home/user/Segmentation_final3/irseg/edge/' + label_path1 + '.png', c)
    cv2.imwrite('/home/user/Segmentation_final3/irseg/edgevisual/' + label_path1 + '.png', c)
    # print(c.shape)
    #
